...
SAITAMA_IMG = "https://raw.githubusercontent.com/shwetha222/GroupBot/main/Assests/repository-open-graph-template.png"
...
def main():
    ...
    if WEBHOOK:
        ...
        updater.start_webhook(listen="0.0.0.0", port=process.env.PORT, url_path=TOKEN)
